...
// viewmanager.cpp
// ============
// manage the viewing of 3D objects within the - camera, projection
//
 ...
 *
 *  This method is automatically called from GLFW whenever the mouse wheel is scrolled within the active window
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS)
	{
		...
		//change the camera settings for a perspective view
		g_pCamera->Position = glm::vec3(0.0f, 5.0f, 12.0f);
		g_pCamera->Front = glm::vec3(0.0f, -0.5f, -2.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
	}
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		...
		// change the camera settings for an orthographic view
		g_pCamera->Position = glm::vec3(2.5f, 2.9f, 8.0f);
		g_pCamera->Front = glm::vec3(0.3f, 0.0f, -5.5f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f); 
	}
